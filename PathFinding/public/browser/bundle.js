...
Board.prototype.toggleTutorialButtons = function() {
  ...
  function nextPreviousClick() {
    if (counter === 1) {
      ...
      document.getElementById("tutorial").innerHTML = `<h3>Enjoy!</h3><h6>this was ported to ADGSTUDIOS by Ashlin Darius Govindasamy, this project was developed by Clement Mihailescu - Co-Founder & CEO, AlgoExpert | Ex-Google & Ex-Facebook Software Engineer</h6><p>If you want to see the source code for this application, check out <a href="https://github.com/ADGVLOGS/adgwebsite/PathFinding">github</a>.</p><br></br><p>(c) ADGSTUDIOS and (c) Clement Mihailescu </p><div id="tutorialCounter">${counter}/9</div><button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
